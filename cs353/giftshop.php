            ...
            <div>
                ...
                <table class="table table-striped align-middle ">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM souvenir WHERE event_id = '$event_id' ";
                        ...
                        while($row = $res_list-> fetch_assoc())
                        {
                            ?>
                            <tr>
                                <td><?= $row["souvenir_id"]; ?></td>
                                <td><?= $row["souvenir_name"]; ?></td>
                                <td><?= $row["souvenir_price"]; ?></td>
                                <td>
                                    <a href ="checkout_souvenir.php?id=<?=$row["souvenir_id"];?>" class="btn btn-primary">Buy Souvenir</a>
                                </td>
                            </tr>
                            <?php
                        }
