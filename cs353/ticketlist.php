            ...
            <div>
                ...
                <table class="table table-striped align-middle">
                    ...
                    <tbody>
                        ...
                        $sql = "WITH ticket_ids as (SELECT DISTINCT ticket_id, purchase_id FROM buy_ticket WHERE user_id = '$glob_name')
                        SELECT event_id, ticket_ids.purchase_id, ticket_type FROM ticket_ids, ticket T WHERE T.ticket_id = ticket_ids.ticket_id";
